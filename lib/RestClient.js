...
RestClient.prototype.request = function (options, callback) {
    ...
    request(options, function (err, response, data) {
        ...
        data = data || {};
        setOutputLanguage(data, options);
        setApiClientResponse(data, response); // hang apiClientResponse on data, as a non-enumerable property.
...
function setOutputLanguage(data, options) {
    if (options.body && options.body.language) {
        data.language = options.body.language;
    }
}

function setApiClientResponse(obj, response) {
