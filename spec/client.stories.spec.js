...
describe('The gavagai API stories resource', function () {
    ...
    var gavagai = new Gavagai('abc123');
    var api;
    ...
    it('should have default language', function(done) {
        ...
        gavagai.stories(docs, function (err, data) {
    ...
    it.skip('should accept an array of texts', function (done) {
        validateApiRequest(requiredValues);
        gavagai.stories(['this is a text', 'this is text 2', 'this is a third text'], function () {
            api.isDone().should.equal(true, "Matching API call.");
            done();
        })
    });
    ...
    it('should handle custom options', function (done) {
        ...
        gavagai.stories(docs, options, function () {
            api.isDone().should.equal(true, "Matching API call.");
            done();
        });
    });
